...
import { contractMainnetAddresses, tokensPerMainnetChain, NATIVE_ADDRESS } from '@/lib/evm-tokens-mainnet-tfs';
...
export function usePaymentsManager(selectedToken: any) {
    ...
    const contractAddress = chain?.id ? contractMainnetAddresses[chain.id as keyof typeof contractMainnetAddresses] : undefined;
